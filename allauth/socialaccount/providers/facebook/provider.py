...
class FacebookAccount(ProviderAccount):
    def get_profile_url(self):
        return self.account.extra_data['fb_profile'].get('link')
    ...
    def to_str(self):
        ...
        return self.account.extra_data['fb_profile'].get('name', dflt)
...
class FacebookProvider(OAuth2Provider):
    ...
    def extract_uid(self, data):
        return data['fb_profile']['id']

    def extract_common_fields(self, data):
        return dict(email=data['fb_profile'].get('email'),
                    username=data['fb_profile'].get('username'),
                    first_name=data['fb_profile'].get('first_name'),
                    last_name=data['fb_profile'].get('last_name'))

    def extract_email_addresses(self, data):
        ret = []
        email = data['fb_profile'].get('email')
        if email:
